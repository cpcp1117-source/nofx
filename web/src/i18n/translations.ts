...
export const translations = {
  en: {
    ...
    collapse: 'Collapse',
    expand: 'Expand',
    klineAnalysis: 'Kline Analysis',
    klineTitle: 'Kline Data (Last 24 Hours)',
    latestHours: 'Last 24 Hours',
    analysisResult: 'Period Analysis Result',
    open: 'Open',
    high: 'High',
    close: 'Close',
    low: 'Low',
    ...
    aiMode: 'AI Adaptive (LLM)',
    quantResonanceMode: 'Quant Resonance (Rules)',
    ...
    // Quant Resonance Mode
    quantParams: 'Quantitative Parameters',
    volumeSmaPeriod: 'Volume SMA Period (N)',
    volumeSmaPeriodDesc: 'Used for Step 3 volume spike confirmation (default 50)',
    rsiBuyThreshold: 'RSI Buy Threshold',
    rsiSellThreshold: 'RSI Sell Threshold',
    rsiThresholdDesc: 'RSI turnaround trigger levels (default 30/70)',
    sopRulesTitle: 'SOP Decision Rules',
    sopStep1: 'Step 1: HTF Trend (1D/4H MACD & BOLL Slope)',
    sopStep2: 'Step 2: MTF S/R (Pullback to Box Support/Resistance)',
    sopStep3: 'Step 3: LTF Trigger (RSI Turn + Reversal K + Vol Spike)',
    riskManagement: 'Risk Management',
    maxRiskPerTrade: 'Max Risk per Trade (% Balance)',
    maxRiskDesc: 'Position size will be capped to keep risk under 2% (ATR-based SL)',
    ...
    strategyStudio: {
      ...
      quantResonance: 'Quant Resonance',
      quantResonanceDesc: 'Rule-based multi-timeframe resonance strategy',
      quantResonanceConfig: 'Quant Resonance Config',
  ...
  zh: {
    ...
    expand: '▶ 展开',
    klineAnalysis: 'K线分析',
    klineTitle: 'K线情況 (最近24個小時)',
    latestHours: '最近24個小時',
    analysisResult: '週期判斷結果',
    open: '開盤',
    high: '最高',
    close: '收盤',
    low: '最低',
    ...
    discount: '折扣优惠',
    selectTradingStrategy: '選擇交易策略',
    tradingMode: '交易模式',
    aiMode: 'AI 自適應 (LLM)',
    quantResonanceMode: '量化共振 (規則)',
    useStrategy: '使用策略',
    ...
    // Quant Resonance Mode
    quantParams: '量化參數設定',
    volumeSmaPeriod: '成交量均線週期 (N)',
    volumeSmaPeriodDesc: '用於 Step 3 的量能噴發確認 (預設 50)',
    rsiBuyThreshold: 'RSI 買入閾值',
    rsiSellThreshold: 'RSI 賣出閾值',
    rsiThresholdDesc: 'RSI 拐頭觸發位 (預設 30/70)',
    sopRulesTitle: 'SOP 決策鏈規則',
    sopStep1: 'Step 1: HTF 大週期趨勢 (1D/4H MACD 與布林斜率)',
    sopStep2: 'Step 2: MTF 中週期支撐壓力 (箱體或布林關鍵位)',
    sopStep3: 'Step 3: LTF 小週期觸發 (RSI 拐頭 + 反轉 K + 放量)',
    riskManagement: '風控與資金管理',
    maxRiskPerTrade: '單筆最大風險 (% 資金)',
    maxRiskDesc: '系統將自動計算倉位，確保單筆損失不超過 2% (基於 ATR 止損)',
    ...
    strategyStudio: {
      ...
      quantResonance: '量化共振',
      quantResonanceDesc: '基於多週期共振的規則化量化策略',
      quantResonanceConfig: '量化共振配置',
      gridConfig: '网格配置',
      coinSource: '币种来源',
      indicators: '技术指标',
      riskControl: '风控参数',
  ...
  id: {
    ...
    collapse: 'Tutup',
    expand: 'Buka',
    klineAnalysis: 'Analisis Kline',
    klineTitle: 'Data Kline (24 Jam Terakhir)',
    latestHours: '24 Jam Terakhir',
    analysisResult: 'Hasil Analisis Periode',
    open: 'Buka',
    high: 'Tertinggi',
    close: 'Tutup',
    low: 'Terendah',
    ...
    time: 'Waktu',
    trend: 'Tren',
    klineCount: 'Hitungan Kline',
    noKlineData: 'Data kline tidak tersedia',
    ...
    strategyStudio: {
      ...
      quantResonance: 'Quant Resonance',
      quantResonanceDesc: 'Strategi kuantitatif berbasis resonansi multi-timeframe',
      quantResonanceConfig: 'Konfigurasi Quant Resonance',
